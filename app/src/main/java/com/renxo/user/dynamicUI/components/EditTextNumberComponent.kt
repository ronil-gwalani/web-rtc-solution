...
fun EditTextNumberComponent(
    ...
    val requirements = inputData.requirements as Requirements.EditTextNumberRequirements
    ...
    val min = requirements.min?.toIntOrNull() ?: Int.MIN_VALUE
    val max = requirements.max?.toIntOrNull() ?: Int.MAX_VALUE
            ...
            onValueChange = { newValue ->
                if (inputData.editable) {
                    ...
                    if (parsedValue != null) {
                        ...
                        showError = parsedValue !in min..max
...
//                        textValue.value = ""
        ...
        if (showError) {
            Text(
                text = stringResource(R.string.value_must_be_in_range_of_and, min, max),
                color = Color.Red,
